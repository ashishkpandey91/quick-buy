            ...
            <div class="flex flex-col items-center justify-between">
              <div class="my-2 flex justify-between gap-2 text-xl">
                <div class="flex gap-2 relative overflow-hidden">
                  ...
                  <i class="fa-regular fa-star text-yellow-500"></i>
                  <div
                    class="absolute top-0 left-0 flex gap-2 w-[${(Number(response[i].rating.rate))*20}%] overflow-hidden"
                  >
              ...
              <p class="text-xl font-bold text-my-custom-color my-2">
                ₹ ${response[i].price}
                <del class="text-base text-gray-500 font-normal">₹  ${((response[i].price)+49).toFixed(2)}</del>
              </p>
            </div>
